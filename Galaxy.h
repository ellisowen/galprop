...
class Galaxy {
 ...
 public:
  ...
  Distribution synchrotron_polang_skymap;// synchrotron polarization angle   Cartesian skymap AWS20131004
  Distribution synchrotron_polfra_skymap;// synchrotron polarized fraction   Cartesian skymap AWS20131004
  ...
  Skymap<double> synchrotron_polang_hp_skymap;// synchrotron polarization angle    healpix skymap                  AWS20131004
  Skymap<double> synchrotron_polfra_hp_skymap;// synchrotron polarized fraction    healpix skymap                  AWS20131004

  Distribution   free_free_emiss;       // free-free emissivity                                                    AWS20131004
  Distribution   free_free_skymap;      // free-free intensity Cartesian skymap                                    AWS20131004
  Skymap<double> free_free_hp_skymap;   // free-free intensity healpix skymap                                      AWS20131004
