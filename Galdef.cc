...
Galdef::~Galdef() {
  ...
  if ( deleteMemory ) {
    ...
    //    delete[] B_field_parameters; AWS20131003 now a string
    delete[] cr_source_x;
    delete[] cr_source_y;
    delete[] cr_source_z;
    delete[] cr_source_w;
...
int Galdef::read ( const string& theVersion,
    ...
    positron_source_normalization =1.;                                                    //AWS20131022
    strcpy ( parstring,                              "positron_source_norm" );            //AWS20131022
    stat= read_galdef_parameter ( filename,parstring,&positron_source_normalization );    //AWS20131022
    ...
    //space diffusion
    strcpy ( parstring,                              "Diffusion_aniso" );//AWS20131017
    stat= read_galdef_parameter ( filename,parstring,&Diffusion_aniso ); //AWS20131017
    strcpy ( parstring,                              "D0_xx" );
    stat= read_galdef_parameter ( filename,parstring,&D0_xx );
    strcpy ( parstring,                              "D0_zz" );//AWS20131017
    stat= read_galdef_parameter ( filename,parstring,&D0_zz ); //AWS20131017
    ...
    strcpy ( parstring,                              "z0_conv" );        //AWS20131008
    stat= read_galdef_parameter ( filename,parstring,&z0_conv  );        //AWS20131008
    ...
    strcpy ( parstring,                              "nuc_rigid_br0" ); //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&nuc_rigid_br0 );  //AWS20131111
    strcpy ( parstring,                              "nuc_rigid_br" );
    stat= read_galdef_parameter ( filename,parstring,&nuc_rigid_br );
   strcpy ( parstring,                               "nuc_rigid_br2" ); //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&nuc_rigid_br2 );  //AWS20131111
    ...
    strcpy ( parstring,                              "nuc_g_3" );       //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&nuc_g_3 );        //AWS20131111
    ...
    strcpy ( parstring,                              "electron_rigid_br2" );      //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&electron_rigid_br2 );       //AWS20131111
    strcpy ( parstring,                              "electron_g_3" );            //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&electron_g_3 );             //AWS20131111

    //injection spectra parametrization (positrons)                         AWS20131022
    strcpy ( parstring,                              "positron_g_0" );   
    stat= read_galdef_parameter ( filename,parstring,&positron_g_0 );
    strcpy ( parstring,                              "positron_rigid_br0" );
    stat= read_galdef_parameter ( filename,parstring,&positron_rigid_br0 );
    strcpy ( parstring,                              "positron_g_1" );
    stat= read_galdef_parameter ( filename,parstring,&positron_g_1 );
    strcpy ( parstring,                              "positron_rigid_br" );
    stat= read_galdef_parameter ( filename,parstring,&positron_rigid_br );
    strcpy ( parstring,                              "positron_g_2" );
    stat= read_galdef_parameter ( filename,parstring,&positron_g_2 );
    strcpy ( parstring,                              "positron_rigid_br2" );      //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&positron_rigid_br2 );       //AWS20131111
    strcpy ( parstring,                              "positron_g_3" );            //AWS20131111
    stat= read_galdef_parameter ( filename,parstring,&positron_g_3 );             //AWS20131111
    ...
    renorm_off        = 0;                   // default                   //ECC20150128
    strcpy ( parstring,                              "renorm_off" );      
    stat= read_galdef_parameter ( filename,parstring,&renorm_off );      
    
    uniform_emiss     = 0;                   // default                   
    strcpy ( parstring,                              "uniform_emiss" );      
    stat= read_galdef_parameter ( filename,parstring,&uniform_emiss );      //ECC20150128

    single_component     = 0;                   // default                   
    strcpy ( parstring,                              "single_component" );      
    stat= read_galdef_parameter ( filename,parstring,&single_component );    //ECC20150128
    ...
    //CO cube file
    strcpy ( parstring,                              "COCube_filename" );                //ECC20141024
    stat= read_galdef_parameter ( filename,parstring, COCube_filename );                 //ECC20141024
    strcpy ( parstring,                              "COCube_rlb_filename" );                //ECC20141024
    stat= read_galdef_parameter ( filename,parstring, COCube_rlb_filename );                 //ECC20141024


    //HI cube file
    strcpy ( parstring,                              "HICube_filename" );                //ECC20141024
    stat= read_galdef_parameter ( filename,parstring, HICube_filename );                 //ECC20141024
    strcpy ( parstring,                              "HICube_rlb_filename" );                //ECC20141024
    stat= read_galdef_parameter ( filename,parstring, HICube_rlb_filename );                 //ECC20141024
    ...
    strcpy ( parstring,                              "solution_method" );     // Deepak Dec 10, 2012
    stat= read_galdef_parameter ( filename,parstring,&solution_method );      // Deepak Dec 10, 2012
    strcpy ( parstring,                              "solution_convergence" );// Deepak Dec 10, 2012
    stat= read_galdef_parameter ( filename,parstring,&solution_convergence ); // Deepak Dec 10, 2012 
    ...
    strcpy ( parstring,                              "spatial_bound_conds" ); //AWS20131028
    stat= read_galdef_parameter ( filename,parstring,&spatial_bound_conds );  //AWS20131028
    ...
    strcpy ( parstring,                              "primary_positrons" );//AWS20131022
    stat= read_galdef_parameter ( filename,parstring,&primary_positrons ); //AWS20131022
    ...
    strcpy ( parstring,                              "free_free_absorption"); //AWS20131004
    stat= read_galdef_parameter ( filename,parstring,&free_free_absorption ); //AWS20131004


    //CR source parameters
    strcpy ( parstring,                              "spiral_fraction" );
    stat= read_galdef_parameter ( filename,parstring,&spiral_fraction );
    strcpy ( parstring,                              "kennicutt_index" );
    stat= read_galdef_parameter ( filename,parstring,&kennicutt_index );    
    strcpy ( parstring,                              "kennicutt_threshold" );
    stat= read_galdef_parameter ( filename,parstring,&kennicutt_threshold );
    ...
    //If not defined, positron source model is the same as nuclei
    source_model_positron = source_model;
    strcpy ( parstring,                               "source_model_posi" );   //AWS20131022
    stat = read_galdef_parameter ( filename,parstring,&source_model_positron );//AWS20131022

    //Resize the source_parameters vectors
    source_parameters.resize(10);
    source_parameters_electron.resize(10);
    source_parameters_positron.resize(10);//AWS20131022

    for (int iS = 0; iS < 10; ++iS) {

      ostringstream buf1, buf2,buf3;      //AWS20131022
      buf1 << "source_parameters_" << iS;
      buf2 << "source_pars_elec_"  << iS;
      buf3 << "source_pars_posi_"  << iS; //AWS20131022

      source_parameters[iS] = source_parameters_electron[iS] = source_parameters_positron[iS]= (4 == iS ? 100 : 0);

      if(iS==0) //AWS20131107 default for zscale
      source_parameters[iS] = source_parameters_electron[iS] = source_parameters_positron[iS]=0.2;//AWS20131107
      ...
      strcpy ( parstring, buf3.str().c_str() );                                           //AWS20131022
      stat = read_galdef_parameter ( filename,parstring,&source_parameters_positron[iS] );//AWS20131022
    ...
    */
    ...
    for (int iS = 0; iS < 10; ++iS) {
       ...
       srcBuf.str("");
      srcBuf << iS << " source_parameters:" << source_parameters[iS] << " electrons:" << source_parameters_electron[iS] << " positrons: " << source_parameters_positron[iS];
    INFO(srcBuf.str());
...
//   strcpy ( B_field_name,"galprop_original" );                                 // default if absent in galdef file             //AWS20080312
              B_field_name="galprop_original";                                   // default if absent in galdef file             //AWS20131003 now a string
    ...
    stat= read_galdef_parameter ( filename,parstring,&n_B_field_parameters );                                                    //AWS20131003 now a string

    if ( n_B_field_parameters!=10 ) {FATAL("need exactly 10 B-field parameters in this version!"); exit ( 1 );}             //AWS20080313

    //    B_field_parameters=new double[n_B_field_parameters];                                                                         //AWS20131003 now a string allocated in read
...
//	 &B_field_parameters[5],&B_field_parameters[6],&B_field_parameters[7],&B_field_parameters[8],&B_field_parameters[9])  ;//AWS20080312
    ...
    strcpy ( parstring,                              "HII_Te");              //AWS20131004
    stat= read_galdef_parameter ( filename,parstring,&HII_Te );              //AWS20131004

    strcpy ( parstring,                              "HII_clumping_factor"); //AWS20131004
    stat= read_galdef_parameter ( filename,parstring,&HII_clumping_factor ); //AWS20131004
    ...
    strcpy ( parstring,                              "DM_antideuterons" );
    stat= read_galdef_parameter ( filename,parstring,&DM_antideuterons );
    strcpy ( parstring,                              "DM_antihelium" );
    stat= read_galdef_parameter ( filename,parstring,&DM_antihelium );
...
read_galdef_parameter ( const std::string& filename,
                        char *parstring,
                        std::vector<double> &value, // wanted *value for consistency with other functions  but could not make it work
                        int size ) {
   if (size == 0) return 0;
    FILE *ft = fopen ( filename.c_str(),"r" );
    if ( !ft )
    ...
    double *value_;         //AWS20131003
    value_=new double[size];//AWS20131003

    value.resize(size);     //AWS20131003
    ...
    while ( found!=0 ) {
	   ...
	   ostringstream buf;
        ...
        if ( found==0 ) {
            ...
            int inc;
            for ( int i = 1; i < size; ++i ) {
	      sscanf ( &input[start], "%le,%n", &value_[i-1], &inc ); //AWS20131003
                start += inc;
            }
              sscanf ( &input[start], "%le",    &value_[size-1] );    //AWS20131003
              //cout<<parstring<<"    found!"<<endl;
              //cout<<endl<<"difread: value of "<< parstring <<"="<<value_[i-1] <<endl;
        }
    }

    for(int i=0;i<size;i++) value[i]=value_[i];                      //AWS20131003
...
read_galdef_parameter ( const std::string& filename,
    ...
    char dumstring[Bufferlength];//IMOS20080114
    char input    [Bufferlength];//IMOS20080114
    char value_   [Bufferlength];//AWS20131003
    int stat=0;
    ...
    while ( found!=0 ) {
	   ...
	   ostringstream buf;
        ...
        if ( found==0 ) {
            sscanf ( input,"%22c%s"   ,dumstring, value_ );    // s for char string 
            *value=value_;// char to string AWS20131003
            // cout<<parstring<<"    found!"<<endl;
            // cout<<endl<<"difread: value of "<< parstring <<"="<<*value <<endl;
        }
    }
...
void Galdef::print() {
    ...
    cout<<"  Diffuseion_aniso "<<Diffusion_aniso <<endl; //AWS20131017
    cout<<"  D0_xx       "<<D0_xx         <<endl;
    cout<<"  D0_zz       "<<D0_zz         <<endl;        //AWS20131017
    ...
    cout<<"  z0_conv     "<<z0_conv       <<endl; //AWS20131008
    ...
    cout<<"  nuc_g_0       "<<nuc_g_0         <<endl; //AWS20131111
    cout<<"  nuc_rigid_br0 "<<nuc_rigid_br0   <<endl; //AWS20131111
    cout<<"  nuc_g_1       "<<nuc_g_1         <<endl;
    cout<<"  nuc_rigid_br  "<<nuc_rigid_br    <<endl;
    cout<<"  nuc_g_2       "<<nuc_g_2         <<endl;
    cout<<"  nuc_rigid_br2 "<<nuc_rigid_br2   <<endl; //AWS20131111
    cout<<"  nuc_g_3       "<<nuc_g_3         <<endl; //AWS20131111
    ...
    cout<<"  electron_rigid_br2 "<<electron_rigid_br2   <<endl; //AWS20131111
    cout<<"  electron_g_3       "<<electron_g_3         <<endl; //AWS20131111


    cout<<"  positron_g_0       "<<positron_g_0         <<endl;// AWS20131022 
    cout<<"  positron_rigid_br0 "<<positron_rigid_br0   <<endl;
    cout<<"  positron_g_1       "<<positron_g_1         <<endl;
    cout<<"  positron_rigid_br  "<<positron_rigid_br    <<endl;
    cout<<"  positron_g_2       "<<positron_g_2         <<endl;
    cout<<"  positron_rigid_br2 "<<positron_rigid_br2   <<endl; //AWS20131111
    cout<<"  positron_g_3       "<<positron_g_3         <<endl; //AWS20131111
    ...
    cout<<"  solution_method   "<< solution_method<<endl;                // Deepak Dec 10, 2012   
    cout<<"  solution_convergence     "<<   solution_convergence<<endl;  // Deepak Dec 10, 2012
    ...
    cout<<"  spatial_bound_conds "<<spatial_bound_conds<<endl; //AWS20131028
    ...
    cout<<"  source_parameters_0   "<<source_parameters[0] <<endl;//AWS20131107
    ...
    cout<<"  source_parameters_8   ="<<source_parameters[8] <<endl;
    cout<<"  source_parameters_9   ="<<source_parameters[9] <<endl;
    cout<<"  spiral_fraction   ="<<spiral_fraction <<endl;
    cout<<"  kennicutt_index   ="<<kennicutt_index <<endl;
    cout<<"  kennicutt_threshold   ="<<kennicutt_threshold <<endl;
  //cout<<"  source_parameters_10  ="<<source_parameters[10]<<endl; //AWS20131107
    ...
    cout<<"  source_parameters_electron_0    "<<source_parameters_electron[0]  <<endl; //AWS20131107
    ...
    cout<<"  source_parameters_electron_8    ="<<source_parameters_electron[8] <<endl; //AWS20100507
    cout<<"  source_parameters_electron_9    ="<<source_parameters_electron[9] <<endl; //AWS20100507
  //cout<<"  source_parameters_electron_10   ="<<source_parameters_electron[10]<<endl; //AWS20131107

    cout<<"  source_model_positron           "<<source_model_positron          <<endl; //AWS20131022
    cout<<"  positron_source_normalization   "<<positron_source_normalization  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_0    "<<source_parameters_positron[0]  <<endl; //AWS20131107
    cout<<"  source_parameters_positron_1    "<<source_parameters_positron[1]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_2    "<<source_parameters_positron[2]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_3    "<<source_parameters_positron[3]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_4    "<<source_parameters_positron[4]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_5    "<<source_parameters_positron[5]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_6    "<<source_parameters_positron[6]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_7    "<<source_parameters_positron[7]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_8    "<<source_parameters_positron[8]  <<endl; //AWS20131022
    cout<<"  source_parameters_positron_9    "<<source_parameters_positron[9]  <<endl; //AWS20131022
    ...
    cout<<"  HII_Te                "<<HII_Te               <<endl;   
    cout<<"  HII_clumping_factor   "<<HII_clumping_factor  <<endl;   
    ...
    cout<<"  positron_norm_Ekin    "<<positron_norm_Ekin   <<endl;
    cout<<"  positron_norm_flux    "<<positron_norm_flux   <<endl;
    ...
    cout<<"  primary_positrons     "<<primary_positrons    <<endl;
    ...
    cout<<"  free_free_absorpion   "<<free_free_absorption <<endl;

// DM: IMOS20050912
    cout<<"  DM_positrons          "<<DM_positrons         <<endl;
    cout<<"  DM_electrons          "<<DM_electrons         <<endl;
    cout<<"  DM_antiprotons        "<<DM_antiprotons       <<endl;
    cout<<"  DM_antideuterons      "<<DM_antideuterons     <<endl;
    cout<<"  DM_antihelium         "<<DM_antihelium        <<endl;
...
void AssignDefaultParameters ( Galdef& g ) {
    ...
    g.Diffusion_aniso      =0;      //AWS20131017 
    g.D0_xx                =5.75e28;
    g.D0_zz                =5.75e27;//AWS20131017
    ...
    g.v0_conv              =0.;
    g.dvdz_conv            =10.;
    g.z0_conv              = 1.; //AWS20131008

    g.nuc_g_0              =1.50;  //AWS20131111
    g.nuc_rigid_br0        =1.0e0; //AWS20131111
    g.nuc_g_1              =1.82;
    g.nuc_rigid_br         =9.0e3;
    g.nuc_g_2              =2.36;
    g.nuc_rigid_br2        =1.0e8; //AWS20131111
    g.nuc_g_3              =3.00 ; //AWS20131111
    ...
    g.electron_g_2         =5.0;
    g.electron_rigid_br2   =2.0e9;//AWS20131111
    g.electron_g_3         =6.0;  //AWS20131111

    g.positron_g_0         =1.60; //AWS20131022
    g.positron_rigid_br0   =4.0e3;
    g.positron_g_1         =2.50;
    g.positron_rigid_br    =1.0e9;
    g.positron_g_2         =5.0;
    g.positron_rigid_br2   =3.0e9;//AWS20131111
    g.positron_g_3         =7.0;  //AWS20131111
    ...
    strcpy ( g.COCube_filename," " ); //ECC20141024
    strcpy ( g.HICube_filename," " ); //ECC20141024

    g.B_field_model        = 050100020;

    g.HII_Te               = 7000.;          //AWS20131004
    g.HII_clumping_factor  =  100.;          //AWS20131004
...
//  g.ISRF_factors[2]      = 1.0;
    ...
    g.solution_method      =  1 ;    // Deepak Dec 10, 2012 
    g.solution_convergence =  0 ;    // Deepak Dec 10, 2012
    ...
    g.spatial_bound_conds  = 1; //AWS20131028
    ...
    g.spiral_fraction = 0.0; //EC20141112 
    g.kennicutt_index = 1.0; //EC20141112 
    g.kennicutt_threshold = 0.0; //EC20141112 

    g.source_parameters.resize(10);
    g.source_parameters_electron.resize(10);
    g.source_parameters_positron.resize(10); //AWS20131022
    for (int iS = 0; iS < 10; ++iS) {
      
      g.source_parameters[iS] = g.source_parameters_electron[iS] = g.source_parameters_positron[iS] = 0.; //AWS20131022

      if(iS==0) //AWS20131107 default for zscale
      g.source_parameters[iS] = g.source_parameters_electron[iS] = g.source_parameters_positron[iS] = 0.2;//AWS20131107

      if(iS==4) //AWS20131107 default for rconst
      g.source_parameters[iS] = g.source_parameters_electron[iS] = g.source_parameters_positron[iS] = 100.;//AWS20131107
    ...
    g.positron_norm_Ekin   = 35.5e3;
    g.positron_norm_flux   = .50e-9;
...
//  g.isotopic_abundance[2][4]= 7.199e+04;
    ...
    g.primary_positrons    = 0; //AWS20131022
    ...
    g.IC_anisotropic       = 0;
    g.synchrotron          = 1;
    g.free_free_absorption = 1; //AWS20131004
    g.bremss               = 1;

    g.DM_positrons         = 0;
    g.DM_electrons         = 0;
    g.DM_antiprotons       = 0;
    g.DM_antideuterons     = 0;
    g.DM_antihelium        = 0;
    g.DM_gammas            = 0;
