...
// calculate the number of species
   ...
   if(galdef.primary_positrons)     n_species++; //AWS20131023
...
// DM decay species: IMOS20050912
   ...
   if(galdef.DM_antideuterons)      n_species++;
   if(galdef.DM_antihelium)         n_species++;
...
// PRIMARY POSITRONS                                                       AWS20131023

   if(galdef.primary_positrons)
   {
      strcpy(name,"primary_positrons");
...
// DM ANTIPROTONS   IMOS20050912
   ...
   if(galdef.DM_antiprotons)
   {
    ...
    // DM ANTIDEUTERONS ECC20150601
    if(galdef.DM_antideuterons)
    {


        strcpy(name,"DM_antideuterons");
        Z=-1;  A=2;  t_half[0]=0.0;                                         // IMOS20010816
    ...
    // DM ANTIHELIUM ECC20150601
    if(galdef.DM_antihelium)
    {
        strcpy(name,"DM_antihelium");
        Z=-2;  A=3;  t_half[0]=0.0;                                         // IMOS20010816
