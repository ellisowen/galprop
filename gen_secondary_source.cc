...
int Galprop::gen_secondary_source(Particle& particle) {
  ...
  if (particle_name == "primary_electrons"|| particle_name == "primary_positrons") { // Primary  AWS20131023
  ...
  */
  ...
  if (particle_name == "DM_positrons" ||
      ...
      particle_name == "DM_antideuterons" || 
      particle_name == "DM_antihelium") {
  ...
  */
  ...
  // pp-> d fusion source AWS20140505

  if(particle.Z==1 && particle.A==2)                //AWS20140505
  {                                                 //AWS20140505
   INFO("pp->d deuterium fusion source");           //AWS20140505
   gen_secondary_deuterium_fusion_source(particle); //AWS20140505
  }                                                 //AWS20140505
