...
int Galprop::read_gas_cubes(char* type)
 {
    ...
    if( !strcmp ("COCube_rlb",type) ) {filename += galdef.COCube_rlb_filename;}//strcat(filename,galdef.COR_filename);
    if( !strcmp ("HICube_rlb",type) ) {filename += galdef.HICube_rlb_filename;}//strcat(filename,galdef.COR_filename);
    ...
    if( fits_open_file(&fptr,filename.c_str(),READONLY,&status) ) {
       ...
       if (!strcmp ("HICube_rlb",type)) {
        throw std::runtime_error("Failed to open HI_rlb data cube \"" + filename + "\".  Check HICube_rlb_filename in galdef.");
       }
       if (!strcmp ("COCube",type)) {
        throw std::runtime_error("Failed to open CO data cube \"" + filename + "\".  Check COCube_filename in galdef.");
       }
       if (!strcmp ("COCube_rlb",type)) {
        throw std::runtime_error("Failed to open CO_rlb data cube \"" + filename + "\".  Check COCube_rlb_filename in galdef.");
       }
    }
    ...
    if( fits_movabs_hdu(fptr,1,&HDU_TYPE,&status) ) 
      cout<<"10read "<<type<<" status= "<<status<<endl;
    if( fits_read_img(fptr,TFLOAT,felement,nelements,&nulval,image,&anynul,&status) )
      cout<<"#read "<<type<<" status= "<<status<<endl;
    
    /*double Integrated_Gas_Density = 0;
    for (int i=0; i<nelements; i++ )
      Integrated_Gas_Density += image[i]*CDELT1*CDELT2*CDELT3; */


    if (!strcmp ("HICube",type)) {
        HICubeData.Data = image;
        HICubeData.NAXIS1 = NAXIS1; HICubeData.NAXIS2 = NAXIS2; HICubeData.NAXIS3 = NAXIS3;
        HICubeData.CRVAL1 = CRVAL1; HICubeData.CRVAL2 = CRVAL2; HICubeData.CRVAL3 = CRVAL3;
        HICubeData.CDELT1 = CDELT1; HICubeData.CDELT2 = CDELT2; HICubeData.CDELT3 = CDELT3;
        HICubeData.total  = -1;
    }

    else if (!strcmp ("HICube_rlb",type)) {
        HICubeData_rlb.Data = image;
        HICubeData_rlb.NAXIS1 = NAXIS1; HICubeData_rlb.NAXIS2 = NAXIS2; HICubeData_rlb.NAXIS3 = NAXIS3;
        HICubeData_rlb.CRVAL1 = CRVAL1; HICubeData_rlb.CRVAL2 = CRVAL2; HICubeData_rlb.CRVAL3 = CRVAL3;
        HICubeData_rlb.CDELT1 = CDELT1; HICubeData_rlb.CDELT2 = CDELT2; HICubeData_rlb.CDELT3 = CDELT3;
        HICubeData_rlb.total  = -1; 
    }

    else if (!strcmp ("COCube",type)) {
        COCubeData.Data = image;
        COCubeData.NAXIS1 = NAXIS1; COCubeData.NAXIS2 = NAXIS2; COCubeData.NAXIS3 = NAXIS3;
        COCubeData.CRVAL1 = CRVAL1; COCubeData.CRVAL2 = CRVAL2; COCubeData.CRVAL3 = CRVAL3;
        COCubeData.CDELT1 = CDELT1; COCubeData.CDELT2 = CDELT2; COCubeData.CDELT3 = CDELT3;
        COCubeData.total  = -1; 
    }

    else if (!strcmp ("COCube_rlb",type)) {
        COCubeData_rlb.Data = image;
        COCubeData_rlb.NAXIS1 = NAXIS1; COCubeData_rlb.NAXIS2 = NAXIS2; COCubeData_rlb.NAXIS3 = NAXIS3;
        COCubeData_rlb.CRVAL1 = CRVAL1; COCubeData_rlb.CRVAL2 = CRVAL2; COCubeData_rlb.CRVAL3 = CRVAL3;
        COCubeData_rlb.CDELT1 = CDELT1; COCubeData_rlb.CDELT2 = CDELT2; COCubeData_rlb.CDELT3 = CDELT3;
        COCubeData_rlb.total  = -1; 
    }
