...
int test_sync_package()
{
 ...
 nu=1.e9; // 1000 MHz
  ...
  name = "test";
  name = "circular";
  name = "circular2"; parameters[0]=1e-6; parameters[1]=2e-6; // parameters: Breg, Bran
  name = "spiral";    parameters[0]=1e-6; parameters[1]=20.; parameters[2]=2e-6; // parameters: Breg, pitch_angle (deg), Bran
  name = "galprop_original";    parameters[0]= 50100010; // as B_field_model.cc, galdef.B_field_model coded as parameter, avoid leading zeros, taken as hex!
 ...
 /* AWS20111215 B_field_model is obsolete 
 ...
 cout<<"synchrotron_emissivity_aws Rz="<< synch_emissivity_total<<endl;
  ...
  name = "galprop_original";    parameters[0]= 40500030; 
 synch_emissivity_total  =
 synchrotron_emissivity_B_field(  gamma,  nu, 
				  name, parameters, x, y, z, options,
                                  x0, y0, z0,
